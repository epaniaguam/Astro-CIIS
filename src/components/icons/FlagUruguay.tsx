...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
    ...
    >
        ...
        <path
            ...
            style={{ fill: 'none', stroke: '#75aadb', strokeWidth: 18, strokeOpacity: 1 }}
            id="path6"></path>

        <g
            style={{ fill: '#fcd116', stroke: '#000000', strokeWidth: 0.6, strokeMiterlimit: 20 }}
            id="sun"
        >
            <g id="4wavyrays">
                <g id="2wavyrays">
                    ...
                    >
                        <path
                            ...
                            id="path12"></path>
                        <path d="M 0,11 C -2,24 4.5,28 0,33" style={{ fill: 'none' }} id="path14"
                        ></path>
                    </g>
                    <use transform="scale(-1,-1)" xlinkHref="#wavyray"></use>
                </g>
                <use transform="matrix(0,1,-1,0,0,0)" xlinkHref="#2wavyrays"></use>
            </g>
            <use
                transform="matrix(0.7071068,0.7071068,-0.7071068,0.7071068,0,0)"
                xlinkHref="#4wavyrays"></use>

            <g id="4straightrays">
                <g id="2straightrays">
                    <path d="M 0,0 L 6,0 L 0,33 L -6,0 L 0,0 L 0,33" id="straightray"
                    ></path>
                    <use transform="scale(-1,-1)" xlinkHref="#straightray"></use>
                </g>
                <use transform="matrix(0,1,-1,0,0,0)" xlinkHref="#2straightrays"></use>
            </g>
            <use
                transform="matrix(0.7071068,0.7071068,-0.7071068,0.7071068,0,0)"
                xlinkHref="#4straightrays"></use>

            <circle cx="0" cy="0" r="11" id="circle31"></circle>

            <g transform="scale(0.1,0.1)" style={{ fill: '#000000', stroke: 'none' }} id="face">
                <g id="right">
                    <path
                    ...
                    <path
                        ...
                        id="path45"></path>
                    <path d="M 58,57 C 54,50 55,52 47,41 C 55,47 57,50 58,57" id="path47"
                    ></path>
                    <path
                ...
                <use transform="scale(-1,1)" xlinkHref="#right"></use>
                <path d="M 0,76 C -5,76 -18,79 0,79 C 18,79 5,76 0,76" id="path55"></path>
